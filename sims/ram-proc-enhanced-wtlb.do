...
add wave -noupdate /ram_proc/TLB/addr
add wave -noupdate /ram_proc/TLB/physical_addr
add wave -noupdate /ram_proc/TLB/tlb_valid
add wave -noupdate /ram_proc/TLB/tlb_lines
add wave -noupdate /ram_proc/TLB/cont
add wave -noupdate /ram_proc/TLB/miss
